 ...
 */
// MODULE'S VARS
const NS = 'Gtm_Desk_Front_App';

// MODULE'S CLASSES
/**
 * @implements TeqFw_Web_Front_Api_IApp
 */
export default class Gtm_Desk_Front_App {
    constructor(spec) {
        // DEPS
        ...
        /** @type {Gtm_Desk_Front_Layout_Base} */
        const layoutBase = spec['Gtm_Desk_Front_Layout_Base$'];
        ...
        this.init = async function (fnPrintout) {
            ...
            async function initEventProcessors(container) {
                ...
                // await container.get('Gtm_Desk_Front_Hand_Task_Post_Report$');
            }
             ...
             * @memberOf Gtm_Desk_Front_App.init
             */
            ...
            function initRouter(app, DEF, container) {
                ...
                router.addRoute({
                    path: DEF.ROUTE_CFG,
                    component: () => container.get('Gtm_Desk_Front_Ui_Cfg$'),
                });
                router.addRoute({
                    path: DEF.ROUTE_GRAVEYARDS,
                    component: () => container.get('Gtm_Desk_Front_Ui_Graveyards$'),
                });
                router.addRoute({
                    path: DEF.ROUTE_HOME,
                    component: () => container.get('Gtm_Desk_Front_Ui_Home$'),
                });
                router.addRoute({
                    path: DEF.ROUTE_REPORTS,
                    component: () => container.get('Gtm_Desk_Front_Ui_Reports$'),
                });
                router.addRoute({
                    path: DEF.ROUTE_TASKS,
                    component: () => container.get('Gtm_Desk_Front_Ui_Tasks$'),
                });
                router.addRoute({
                    path: DEF.ROUTE_USERS,
                    component: () => container.get('Gtm_Desk_Front_Ui_Users$'),
                });
